namespace Eco.Mods.TechTree
{
    ...
    public partial class TruckYellowObject : PhysicsWorldObject, IRepresentsItem, IStorageSlotObject
    {
        public override LocString DisplayName => Localizer.DoStr("Truck Yellow");
        public Type RepresentedItemType => typeof(TruckYellowItem);

        private static readonly StorageSlotModel SlotDefaults = new(typeof(TruckYellowObject)) { StorageSlots = 36, };
