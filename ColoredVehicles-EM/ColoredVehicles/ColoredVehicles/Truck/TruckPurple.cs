namespace Eco.Mods.TechTree
{
    ...
    public partial class TruckPurpleObject : PhysicsWorldObject, IRepresentsItem, IStorageSlotObject
    {
        public override LocString DisplayName => Localizer.DoStr("Truck Purple");
        public Type RepresentedItemType => typeof(TruckPurpleItem);

        private static readonly StorageSlotModel SlotDefaults = new(typeof(TruckPurpleObject)) { StorageSlots = 36, };
