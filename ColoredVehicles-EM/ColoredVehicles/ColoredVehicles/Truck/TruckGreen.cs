namespace Eco.Mods.TechTree
{
    ...
    public partial class TruckGreenObject : PhysicsWorldObject, IRepresentsItem, IStorageSlotObject
    {
        public override LocString DisplayName => Localizer.DoStr("Truck Green");
        public Type RepresentedItemType => typeof(TruckGreenItem);

        private static readonly StorageSlotModel SlotDefaults = new(typeof(TruckGreenObject)) { StorageSlots = 36, };
