namespace Eco.Mods.TechTree
{
    ...
    public class PaintPoweredCartTechnicalBlueRecipe : RecipeFamily, IConfigurableRecipe
    {
        ...
        {
            ModelType = typeof(PaintPoweredCartTechnicalBlueRecipe).Name,
            Assembly = typeof(PaintPoweredCartTechnicalBlueRecipe).AssemblyQualifiedName,
            HiddenName = "Paint Powered Cart TechnicalBlue",
    ...
    public partial class PoweredCartTechnicalBlueObject : PhysicsWorldObject, IRepresentsItem, IConfigurableVehicle
    {
        ...
        public static VehicleModel defaults = new(
            typeof(PoweredCartTechnicalBlueObject),
