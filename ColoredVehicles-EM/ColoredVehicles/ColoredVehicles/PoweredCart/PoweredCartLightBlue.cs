namespace Eco.Mods.TechTree
{
    ...
    public class PaintPoweredCartLightBlueRecipe : RecipeFamily, IConfigurableRecipe
    {
        static RecipeDefaultModel Defaults => new()
        {
            ...
            HiddenName = "Paint Powered Cart LightBlue",
            LocalizableName = Localizer.DoStr("Paint Powered Cart LightBlue"),
            IngredientList = new()
            {
    ...
    public partial class PoweredCartLightBlueObject : PhysicsWorldObject, IRepresentsItem, IConfigurableVehicle
    {
        public override LocString DisplayName => Localizer.DoStr("Powered Cart LightBlue");
        public Type RepresentedItemType => typeof(PoweredCartLightBlueItem);

        public static VehicleModel defaults = new(
            typeof(PoweredCartLightBlueObject),
            displayName        : "Powered Cart LightBlue",
