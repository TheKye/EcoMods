            ...
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    ...
                    new IngredientElement[]
                    {
                        ...
                        new IngredientElement(typeof(GreenPaintItem), 8, typeof(MechanicsSkill), typeof(MechanicsLavishResourcesTalent)),
                        new IngredientElement(typeof(OrangePaintItem), 8, typeof(MechanicsSkill), typeof(MechanicsLavishResourcesTalent)),
                        new IngredientElement(typeof(PurplePaintItem), 8, typeof(MechanicsSkill), typeof(MechanicsLavishResourcesTalent)),
                    },
