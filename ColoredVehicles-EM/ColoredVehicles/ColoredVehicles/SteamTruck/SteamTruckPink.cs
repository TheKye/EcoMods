namespace Eco.Mods.TechTree
{
    ...
    {
        public override LocString DisplayDescription => Localizer.DoStr("A pink truck that runs on steam.");
    }
    
    public class PaintSteamTruckPinkRecipe : RecipeFamily, IConfigurableRecipe
    {
        static RecipeDefaultModel Defaults => new()
        {
            ModelType = typeof(PaintSteamTruckPinkRecipe).Name,
            Assembly = typeof(PaintSteamTruckPinkRecipe).AssemblyQualifiedName,
            HiddenName = "Paint Steam Truck Pink",
            LocalizableName = Localizer.DoStr("Paint Steam Truck Pink"),
            IngredientList = new()
            {
            ...
            ProductList = new()
            {
                new EMCraftable("SteamTruckPinkItem"),
        ...
        static PaintSteamTruckPinkRecipe() { EMRecipeResolver.AddDefaults(Defaults); }
    ...
    public partial class SteamTruckPinkObject : PhysicsWorldObject, IRepresentsItem, IStorageSlotObject
    {
        public override LocString DisplayName => Localizer.DoStr("Steam Truck Pink");
        public Type RepresentedItemType => typeof(SteamTruckPinkItem);

        private static readonly StorageSlotModel SlotDefaults = new(typeof(SteamTruckPinkObject)) { StorageSlots = 24, };
