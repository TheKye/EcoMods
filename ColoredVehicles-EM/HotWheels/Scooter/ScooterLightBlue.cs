...
namespace Eco.Mods.TechTree
{
    ...
    public class PaintScooterLightBlueRecipe : RecipeFamily, IConfigurableRecipe
    {
        static RecipeDefaultModel Defaults => new()
        {
            ModelType = typeof(PaintScooterLightBlueRecipe).Name,
            Assembly = typeof(PaintScooterLightBlueRecipe).AssemblyQualifiedName,
            HiddenName = "Paint Scooter Light Blue",
            LocalizableName = Localizer.DoStr("Paint Scooter Light Blue"),
            IngredientList = new()
            {
            ...
            ProductList = new()
            {
                new EMCraftable("ScooterLightBlueItem"),
            },
        ...
        static PaintScooterLightBlueRecipe() { EMRecipeResolver.AddDefaults(Defaults); }
